...
console.log(
  `✅ ${iterations} conditional validations: ${totalTime.toFixed(2)}ms`
);
console.log(
  `✅ Average time: ${(totalTime / iterations).toFixed(4)}ms per validation`
);
console.log(
  `✅ Operations per second: ${(iterations / (totalTime / 1000)).toFixed(0)}`
);
