import { InterfaceSchemaFromType, TypeToSchema } from "../schema/mode/interfaces/types/interface.type";
import { ConstantValue, UnionValue, SchemaInterface } from "../types/SchemaValidator.type";
import { RuntimeTypeConverter } from "../schema/mode/interfaces/TypeToSchemaConverter";
...
export class Make {
     ...
     * ```
     */
    static const<const T extends string | number | boolean>(value: T): ConstantValue & { const: T } {
        return {
            const: value,
        };
    }
