...
exports.FORTIFY_METHODS = [
    {
        name: "in",
        description: "Checks if a field value is one of the specified literals. Supports strings, numbers, or constants.",
    ...
    {
        name: "between",
        description: "Checks if a number field is within a specified range (inclusive).",
    ...
    {
        name: "empty",
        description: "Checks if a field is empty (e.g., empty string, array, or object).",
        syntax: "field.$empty()",
        parameters: [],
        returnType: "boolean",
...
//# sourceMappingURL=FORTIFY_METHODS.js.map