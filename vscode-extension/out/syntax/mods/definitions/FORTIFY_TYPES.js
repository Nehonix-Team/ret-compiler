...
exports.FORTIFY_TYPES = [
    ...
    {
        name: "password",
        description: "Validates password complexity with optional length or regex constraints.",
        category: "basic",
        examples: [
            '"password"',
            '"password(8,20)"',
    ...
    {
        name: "unknown",
        description: "Accepts unknown value without validation, ideal for flexible schemas.",
        category: "basic",
    ...
    {
        name: "url.dev",
        description: "Validates development URL format with simple declaration - lost security features.",
        category: "format",
    ...
    {
        name: "json.fast",
        description: "Validates JSON string format with proper syntax checking (fast mode).",
        category: "format",
